...
import { CreateCategoryDto, UpdateCategoryDto, CategoryBackendDto } from '../service';
...
export class CategoryView {
   ...
   */
  private static transformCategories(backendCategories: CategoryBackendDto[]): Category[] {
